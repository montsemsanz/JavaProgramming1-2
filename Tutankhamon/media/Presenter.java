 ...
 * </ol>
 *
 * <p>Præsentationens basale ide er at brugeren vha. af kompasknapperne kan
 ...
 * tekstvinduet forneden.</p>
 * 
 * <p>Presenter er et <em>framework</em>, dvs. det ejer hændelsesløkken.
 ...
 * <code>createCenterComponent</code>.</p>
 *
 * @author Erik Martino, revideret af Erik Ernst
 * @version 2000?, November 2004
 */

public abstract class Presenter extends java.applet.Applet 
                                implements ActionListener
{
    ...
    /**
     * Denne metode bliver kaldt, når der trykkes på knappen "North".
     */
    public abstract void northButtonPressed();
    /**
     * Denne metode bliver kaldt, når der trykkes på knappen "South".
     */
    public abstract void southButtonPressed();
    /**
     * Denne metode bliver kaldt, når der trykkes på knappen "East".
     */
    public abstract void eastButtonPressed();
    /**
     * Denne metode bliver kaldt, når der trykkes på knappen "West".
     */
